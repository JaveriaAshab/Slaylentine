...
// if ($row) {
//     file_put_contents("content.json", json_encode($row, JSON_PRETTY_PRINT));
// } else {
//     echo "No letter found for this user.";
// }
...
<head>
    ...
    <title><?php echo $username; ?>'s letter</title>
...
<body class="unselect">
    <a href="../letter.php" style="font-size: 21px; color: black; padding: 8px;"><i class="fa-regular fa-hand-point-left"></i> Go back</a>
